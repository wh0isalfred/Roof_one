        ...
        <div className="flex min-h-[40rem] flex-col justify-center pt-28 pb-14 lg:min-h-[44rem] lg:pt-32">
          <div className="max-w-[54rem] animate-[rise_0.8s_ease-out_both] motion-reduce:animate-none">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
              <AdvisorButton className="inline-flex h-13 items-center justify-center gap-2 rounded-full bg-accent px-7 font-semibold text-white transition-colors hover:bg-brand-bright">
                Get a roof assessment
                <ArrowRight aria-hidden="true" className="size-4" />
              </AdvisorButton>
              <a
                href={siteConfig.phone.href}
                className="inline-flex h-13 items-center justify-center gap-3 rounded-full border-white/35 pr-6 pl-2 font-semibold transition-colors hover:border-white hover:bg-white/10"
              >

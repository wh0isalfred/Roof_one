    ...
    <dl className="divide-y divide-line border-y border-line">
      {steps
        ...
        .map((step) => (
          <div
            key={step.id}
            className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-x-4 py-3 sm:grid-cols-[9rem_minmax(0,1fr)_auto]"
          >
            ...
            <dd className="col-start-2 row-span-2 row-start-1 sm:col-start-3 sm:row-span-1">
              <button
                ...
                className="flex h-10 items-center rounded-md px-3 text-sm font-semibold text-accent hover:bg-subtle"
              >
